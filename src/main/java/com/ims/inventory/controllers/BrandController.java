...
public class BrandController {
    ...
    public ResponseEntity<SearchResponseDto> loadAll(@RequestBody Brand brand) {
        return new ResponseEntity<SearchResponseDto>(brandService.loadAll(brand), HttpStatus.OK);
    }

    @RequestMapping(value = "load-all-list", method = RequestMethod.POST)
